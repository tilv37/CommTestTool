...
namespace TJSYXY.Communication.TCP
{
    ...
    public class TCPClientManager
    {
        ...
        /// 连接服务器
        /// </summary>
        /// <param name="ipEndPoint">Ip节点</param>
        public void Connect(IPEndPoint ipEndPoint)
        {
            TCPClient.TCPClients[_client_id].Connect(ipEndPoint);
        }
        /// <summary>
        /// 断开服务器
        /// </summary>
        ...
        private TCPMessageReceivedEventHandler _tcpMessageReceivedEventHandler;
        /// <summary>
        /// 接收到服务器的消息时激发该事件
        /// </summary>
        ...
        private TCPMessageSendedEventHandler _tcpMessageSendedEventHandler;

        public event TCPMessageSendedEventHandler TCPMessageSended
        {
            add
            {
                if (_tcpMessageSendedEventHandler == null)
                {
                    TCPClient.TCPClients[_client_id].TCPMessageSended += value;
